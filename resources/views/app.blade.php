...
<head>
	...
	<!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media quer 16 ies -->
		...
		<ul class="nav navbar-nav navbar-right">
			@if (Auth::guest())
				<li><a href="{{ url('/auth/login') }}">Login</a>
					...
					@else
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle=aria-expanded="false">{{ Auth::user()->name }} 
